#!/bin/bash
# name : tc4_1_cifar10_micro_final.sh
# description : 
...
# training controller : val_acc=0.7875, num_epochs=139/150

export PYTHONPATH="$(pwd)"

fixed_arc="0 4 0 1 0 0 0 1 0 1 1 3"
fixed_arc="$fixed_arc 1 0 0 2 1 1 1 1 1 4 1 1"
...
CUDA_VISIBLE_DEVICES=7 python src/cifar10/main.py \
  ...
  --output_dir="outputs_tc4_1_cifar10_micro_final" \
  --batch_size=144 \
  --num_epochs=150 \
  --log_every=50 \
  --eval_every_epochs=1 \
