#!/bin/bash
# name : tc4_3_cifar10_micro_final.sh
# description : 
# child_stack_convs changes from 2 to 1
# find final child network
# child_num_cells changes from 5 to 3
# training controller : val_acc=0.7750, num_epochs=139/150

export PYTHONPATH="$(pwd)"

fixed_arc="1 1 0 0 1 0 0 0 2 0 0 0"
fixed_arc="$fixed_arc 0 1 0 0 1 3 1 0 1 3 0 3"
...
CUDA_VISIBLE_DEVICES=5 python src/cifar10/main.py \
  ...
  --output_dir="outputs_tc4_3_cifar10_micro_final" \
  --batch_size=144 \
  --num_epochs=150 \
  --log_every=50 \
  --eval_every_epochs=1 \
