#!/bin/bash
# name : tc5_1_cifar10_micro_search.sh
# description : 
...
# multi_obj_runtime_threshold set 47000 (100000us * 8/17)
...
CUDA_VISIBLE_DEVICES=4 python src/cifar10/main.py \
  ...
  --output_dir="outputs_tc5_1_cifar10_micro_search" \
  --batch_size=160 \
  --num_epochs=150 \
  --log_every=50 \
  --eval_every_epochs=1 \
  ...
  --multi_obj_runtime_threshold=47000 \
  "$@"
